...
@Injectable()
export class FactorRiesgoPsicosocialService {
    ...
    async getFactorRiesgoPsicosocial() {
        try {
            ...
            const resultado = await result.execute('sp_factor_riesgo_psicosocial');
            return {
            ...
            console.log(error);
            return {
                mensaje: 'Error al listar factores de riesgo psicosocial',
