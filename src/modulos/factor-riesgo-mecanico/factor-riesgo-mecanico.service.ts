...
@Injectable()
export class FactorRiesgoMecanicoService {
    async getFactorRiesgoMecanico() {
        try {
            ...
            const resultado = await result.execute('sp_factor_riesgo_mecanico');
            return {
            ...
            console.log(error);
            return {
                mensaje: 'Error al listar factores de riesgo mecánico',
